...
- Sources Power BI du PBIP = données **FICTIVES pour visualisation**. Aucune connexion Dremio/DAX n'a été testée dans Power BI Desktop Windows dans cet environnement. Rebrancher en conservant noms/colonnes via `docs/POWERBI_CONNECTION_FR.md`.
